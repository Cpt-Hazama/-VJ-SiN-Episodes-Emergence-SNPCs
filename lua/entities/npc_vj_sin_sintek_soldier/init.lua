...
-----------------------------------------------*/
ENT.Model = {"models/vj_sin/characters/mobgrunt/mobgrunt.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want 
ENT.StartHealth = 65
