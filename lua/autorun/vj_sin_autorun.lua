/*--------------------------------------------------
	=============== SiN Episodes: Emergence SNPCs Autorun ===============
	*** Copyright (c) 2012-2016 by DrVrej, All rights reserved. ***
	No parts of this code or any of its contents may be reproduced, copied, modified or adapted,
	without the prior written consent of the author, unless otherwise indicated for stand-alone materials.
INFO: Used to load autorun file for SiN Episodes: Emergence SNPCs
--------------------------------------------------*/
-- Addon Information(Important!):
	local PublicAddonName = "SiN Episodes: Emergence SNPCs"
	local AddonName = "SiN Episodes: Emergence"
...
if( file.Exists( VJExists, "GAME" ) ) then
	...
	AddCSLuaFile("autorun/vj_sin_autorun.lua")
	AddCSLuaFile("autorun/vj_sin_spawn.lua")
